...
export default function Dashboard() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden select-none">
            ...
            <Link to="/" className="absolute top-8 left-8 text-slate-400 hover:text-emerald-600 transition-colors duration-300" title="Back to Home">
                <ArrowLeft className="w-6 h-6" />
            </Link>

            <div className="w-full max-w-[30rem] relative z-10">
                <div className="bg-white/90 backdrop-blur-xl border border-gray-100 shadow-xl rounded-2xl p-8">
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-200/60 text-center">
                        <p className="text-xs text-slate-400">Forgot password? Contact your IT support.</p>
                    </div>
                </div>
            </div>
        </div>

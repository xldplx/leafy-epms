...
/**
 * POST /api/projects
 * Creates a new project. Requires Project Manager role.
 */
const createProject = async (req, res) => {
    const {
        project_name, project_code, description,
        planned_start, planned_end, total_budget, schedule_pct
    } = req.body;
...
/**
 * PUT /api/projects/:id
 * Updates a project. Requires Project Manager role.
 */
const updateProject = async (req, res) => {
    const updates = {};
    const fields = [
        'project_name', 'description', 'planned_start', 'planned_end',
        'total_budget', 'status', 'schedule_pct'
    ];
    fields.forEach(f => {
 ...
 * Deletes a project and all related data (cascade). Requires Project Manager role.
 */
